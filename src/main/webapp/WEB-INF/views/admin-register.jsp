...
<head>
  ...
  <title>Admin Registration - HomeTutor.lk</title>
      ...
      <div class="register-container">
        ...
        <div class="form-section">
          ...
          <form method="post" action="admin-register">
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                <div class="form-floating position-relative">
                  ...
                  <input type="text" class="form-control ps-4" id="fullName" name="fullName"
            ...
            <div class="mb-3">
              <div class="form-floating position-relative">
                ...
                <input type="email" class="form-control ps-4" id="email" name="email"
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                <div class="form-floating position-relative">
                  <i class="fas fa-lock input-icon"></i>
                  <input type="password" class="form-control ps-4" id="confirmPassword" name="confirmPassword"
            ...
            <div class="mb-4">
              <div class="form-floating position-relative">
                ...
                <select class="form-select ps-4" id="role" name="role">
          ...
          <div class="text-center mb-4">
            ...
            <a href="admin-login" class="text-link">
              <i class="fas fa-sign-in-alt me-1"></i>Login to Admin Dashboard
            </a>
          </div>

          <div class="text-center">
            <p class="text-muted mb-2">Looking for student or tutor access?</p>
